...
<figure><img src="../../../.gitbook/assets/image (1).png" alt=""><figcaption><p>A web server receives requests and passes them to a framework. The framework processes the request and generates a response, which is sent back to the browser.</p></figcaption></figure>
